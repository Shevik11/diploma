...
// тФАтФАтФА Aggregate types & helpers тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
// тФАтФАтФА Color palette тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
// тФАтФАтФА Normalization тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА

/** Normalize a set of values to [0, 100]. higherBetter: true тЖТ high raw = high score */
...
function scoreColor(score: number): string {
  const h = Math.round((score / 100) * 120); // 0тЖТred, 120тЖТgreen
  return `hsl(${h}, 65%, 48%)`;
}

// тФАтФАтФА Leaderboard helpers тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
/** Sort by composite leaderboard score (best first). Pure тАФ returns a new array. */
...
// тФАтФАтФА Widget registry тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const ANALYSIS_WIDGETS: WidgetDef[] = [
  ...
  },
  {
    ...
    description: "Normalized efficiency in CPU cores ├Ч RAM GB space",
    group: "analysis",
  },
  {
    id: "oomHeatmap",
    label: "OOM failure heatmap",
    description: "OOM-failure share in RAM ├Ч Model space",
    group: "analysis",
  },
  {
    id: "tpsTcoPareto",
...
// тФАтФАтФА Tooltip helper тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
// тФАтФАтФА 2. Scatter chart тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
// тФАтФАтФА 3. Stacked reliability bar chart тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const ReliabilityWidget = memo(function ({
  ...
  const data = aggregates.map((a) => ({
    model: a.model,
    label: a.model.length > 14 ? `${a.model.slice(0, 13)}тАж` : a.model,
...
// тФАтФАтФА 4. Composed chart (throughput bars + success rate line) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const ComposedWidget = memo(function ({
  ...
  const data = aggregates.map((a) => ({
    model: a.model.length > 12 ? `${a.model.slice(0, 11)}тАж` : a.model,
    fullModel: a.model,
...
// тФАтФАтФА 5. Radial bar (overall composite score) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const RadialScoreWidget = memo(function ({
  ...
  const data = aggregates
    .map((a, i) => ({
      name: a.model.length > 16 ? `${a.model.slice(0, 15)}тАж` : a.model,
      fullName: a.model,
...
// тФАтФАтФА 6. Heatmap тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
              ...
              {HEATMAP_COLS.map((col) => (
                ...
                >
                  ...
                  <span className="block text-[10px] font-normal text-zinc-400">
                    {col.higherBetter ? "тЦ▓ higher" : "тЦ╝ lower"}
                  </span>
                </th>
              ))}
            </tr>
...
// тФАтФАтФА 7. Throughput by model (4 CPU cores + optimal RAM) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
      ...
      <WidgetCard
        title={
          isSingleModel && singleModelName
            ? `Throughput by RAM тАФ ${singleModelName} (4 cores)`
...
// тФАтФАтФА 8. OOM failure heatmap (RAM_GB ├Ч Model) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const OomHeatmapWidget = memo(function ({
  ...
  if (!modelNames.length || !ramValues.length) {
    return (
      <WidgetCard
        ...
        hint="RAM ├Ч Model, 0% (green) тЖТ 100% (red)"
        fullWidth
      >
        <p className="text-sm text-zinc-400 py-6 text-center">
  ...
  return (
    <WidgetCard
      title="OOM failure heatmap"
      hint="RAM ├Ч Model, OOM-failure share over repeated launches (up to first 10 repeats)"
      fullWidth
    >
      <div className="overflow-x-auto">
...
// тФАтФАтФА 9. TPSтАУTCO scatter with Pareto frontier тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const TpsTcoParetoWidget = memo(function ({
  ...
  if (!points.length) {
    return (
      <WidgetCard
        title="TPSтАУTCO Pareto"
        hint="No feasible configurations with TPS + RAM/CPU metadata"
        fullWidth
      >
        <p className="text-sm text-zinc-400 py-6 text-center">
          No data to build TPSтАУTCO scatter. Run benchmarks on RAM/CPU configs first.
        </p>
      </WidgetCard>
    );
  }
...
// тФАтФАтФА 10. E_norm heatmap (CPU_cores ├Ч RAM_GB per model) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
/** Renders a single model's CPU├ЧRAM E_norm grid. */
function ModelEGrid({
  model,
  cpuValues,
  ramValues,
                  ...
                  <td key={cpu} className="p-1 text-center">
                    <div
                      title={[
                        ...
                        `E_norm: ${norm.toFixed(3)}${isRef ? " тШЕ ╨╡╤В╨░╨╗╨╛╨╜" : ""}`,
                        `E: ${cell.e.toFixed(2)}`,
                        `Tok/s: ${r(cell.tok)}`,
                        `CPU: ${r(cell.cpu)}%`,
                        `Mem: ${r(cell.mem)}%`,
...
const EfficHeatmapWidget = memo(function ({
  ...
  // Global maximum E across entire ╬й тАФ shared colour scale.
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-5 flex-wrap">
        ...
        <span className="text-[11px] text-zinc-400">
          max_╬й(E) = {globalMaxE > 0 ? globalMaxE.toFixed(2) : "тАФ"}
        </span>
      </div>
...
// тФАтФАтФА 11. Resource impact line charts (RAM & CPU) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
// тФАтФАтФА 12. Horizontal bar chart (per metric) тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
const BarWidget = memo(function ({
  ...
  const data = aggregates.map((a, i) => {
    const base = a.model.length > 18 ? `${a.model.slice(0, 17)}тАж` : a.model;
    return {
      model: a.model,
  ...
  return (
    <WidgetCard
      ...
      hint={
        leaderboardMode
          ? `Ranked best тЖТ worst (${metric.hint.toLowerCase()})`
          : metric.hint
      }
    >
      <div style={{ height: outerH, overflowY: innerH > outerH ? "auto" : undefined }}>
...
// тФАтФАтФА Widget card wrapper тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
export function ModelDashboard() {
  ...
  // graphs / pill list тАФ infeasible runs and zero-prompt placeholders are
  ...
  // Unique sorted list of base model names тАФ populates the filter <select>.
  ...
  // Leaderboard mode тАФ when ON, charts are reordered so the best-ranked
  ...
  // Maps variant label тЖТ base model name for scatter/radial aggregation.
  ...
  // Aggregates averaged by base model name тАФ used in scatter and radial charts.
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Visual overview of benchmark metrics тАФ radar, scatter, heatmap,
          ...
          <button
            ...
            title={
              leaderboardMode
                ? "Charts ranked best тЖТ worst by composite score (lower-is-better metrics inverted). Click to switch back."
        ...
        <div className="bg-white border border-zinc-200 rounded-lg p-5 shadow-sm">
            ...
            {visibleModels.length > 8 && (
              <label className="flex flex-col gap-1 text-xs sm:col-span-2 lg:col-span-1">
                ...
                <input
                  ...
                  placeholder="Filter variantsтАж"
          ...
          {loadingList ? (
            <div className="flex items-center gap-2 text-sm text-zinc-400">
              <Loader2 className="w-4 h-4 animate-spin" /> LoadingтАж
            </div>
          ) : visibleModels.length === 0 ? (
            <p className="text-sm text-zinc-400">
              {allModels.length === 0
                ? "No benchmark results found тАФ run some benchmarks first."
      ...
      {noData ? (
        <div className="bg-white border border-zinc-200 rounded-lg p-16 text-center text-zinc-400 shadow-sm">
          {selectedModels.size === 0
            ...
            : "Summaries still loading тАФ or run some benchmarks first."}
        </div>
      ) : (
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          {/* Analysis widgets тАФ use composite-ranked order in leaderboard mode */}
          ...
          {/* TPSтАУTCO Pareto scatter тАФ full width */}
          ...
          {/* Per-metric bar charts тАФ in leaderboard mode each is sorted by its own metric */}
